...
{
    public partial class frmPrintPurchase : Form
    {
        SqlConnection cn;
        SqlCommand cm;
        SqlDataReader dr;
        ...
        private void frmPrintPurchase_Load(object sender, EventArgs e)
        {
        ...
        {
            cn.Open();
            da = new SqlDataAdapter("SELECT * FROM vwpurchases WHERE purchaseid = '" + purchaseid + "'", cn);
            DataSet1 ds = new DataSet1();
            da.Fill(ds, "dtPurchase");
